...
export default class ConfigParser {
    ...
    setFilePathToFilterOptions(cliArgFileList, specs) {
        ...
        cliArgFileList.forEach(filteredFile => {
            ...
            let globMatchedFiles = ConfigParser.getFilePaths(this._pathService.glob(filteredFile, path.dirname(this.#configFilePath)), this._config.rootDir, this._pathService);
